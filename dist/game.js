  ...
  function runScene2() {
    ...
    function playerShootsStickys(cells) {
      ...
      for (let i = 0; i < nSticky; i++) {
        ...
        let x = player.pos.x + cell.x;
        let y = player.pos.y + cell.y;
        let dx = const_default.blockSize;
        spot = math_default.rotatePoint({
          x,
          y
        }, player.angle, {
    ...
    __name(playerShootsStickys, "playerShootsStickys");
    ...
    function spawnAlienFlatships() {
      ...
      for (let i = 0; i < nFlatShips; i++) {
        ...
        add([
          ...
          "alien",
          {
            shootChance: 44e-4 + 3e-4 * player.level,
            touchDamage: "extreme",
            laserDamage: "low",
            points: 200
          }
